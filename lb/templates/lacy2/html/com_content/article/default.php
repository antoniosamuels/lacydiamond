...
if ($this->params->get('show_title')) {
 ob_start();
?>
 <h2 class="art-postheader"><?php echo JHTML::_('image.site', 'postheadericon.png', null, null, null, JText::_("postheadericon"), array('width' => '6', 'height' => '6')); ?> 
<?php
...
if ($this->params->get('show_create_date')) {
  artxFragment('', JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '14', 'height' => '13')) . JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_LC2')), '', ' | ');
}
